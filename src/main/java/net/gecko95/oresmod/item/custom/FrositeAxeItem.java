...
public class FrositeAxeItem extends AxeItem {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Frostbite (00:20)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public FrositeAxeItem(ToolMaterial toolMaterial, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        target.addStatusEffect(new StatusEffectInstance(ModEffects.FROSTBITE,400,0),attacker);
