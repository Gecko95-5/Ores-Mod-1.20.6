...
public class EndIteSwordItem extends SwordItem {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Decrease Health (00:20)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public EndIteSwordItem(ToolMaterial toolMaterial, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        target.addStatusEffect(new StatusEffectInstance(ModEffects.DECREASE_HEALTH,400,0),attacker);
