...
public class LeafiteAxeItem extends AxeItem {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Fatal Poison (00:20)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public LeafiteAxeItem(ToolMaterial toolMaterial, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        target.addStatusEffect(new StatusEffectInstance(ModEffects.FATAL_POISON,400,0),attacker);
