...
public class FrositeSwordItem extends SwordItem {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Slowness (00:20)").formatted(DESDESCRIPTION_FORMATTING);
