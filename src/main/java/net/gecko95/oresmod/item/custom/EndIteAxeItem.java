...
public class EndIteAxeItem extends AxeItem {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Void Sickness (00:20)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public EndIteAxeItem(ToolMaterial toolMaterial, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        target.addStatusEffect(new StatusEffectInstance(ModEffects.VOID_SICKNESS,400,0),attacker);
