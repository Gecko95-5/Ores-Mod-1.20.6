...
public class SlownessPotionTankBlock extends Block {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Slowness (01:30)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public SlownessPotionTankBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (entity instanceof LivingEntity livingEntity){
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS,1800));
        }
