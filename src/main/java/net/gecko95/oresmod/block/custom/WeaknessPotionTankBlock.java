...
public class WeaknessPotionTankBlock extends Block {
    ...
    private static final Text DESEFFECT_TEXT = Text.literal("Weakness (01:30)").formatted(DESDESCRIPTION_FORMATTING);
    ...
    public WeaknessPotionTankBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (entity instanceof LivingEntity livingEntity){
            livingEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS,1800));
        }
