...
public class ModBlocks {
    public static final Block SALT_ORE = registerBlock("salt_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.COAL_ORE)));
    ...
    public static final Block ICE_FROSITE_ORE = registerBlock("ice_frosite_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5), AbstractBlock.Settings.copy(Blocks.IRON_ORE)
    ...
    public static final Block CHISELED_FROSITE = registerBlock("chiseled_frosite",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK)));

    public static final Block FROSITE_BRICK_STAIRS = registerBlock("frosite_brick_stairs",
            new StairsBlock(ModBlocks.FROSITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.FROSITE_BRICKS)));
    public static final Block FROSITE_BRICK_SLAB = registerBlock("frosite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BRICKS)));
    public static final Block FROSITE_BRICK_WALL = registerBlock("frosite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BRICKS)));

    public static final Block CUT_FROSITE_STAIRS = registerBlock("cut_frosite_stairs",
            new StairsBlock(ModBlocks.CUT_FROSITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.CUT_FROSITE)));
    public static final Block CUT_FROSITE_SLAB = registerBlock("cut_frosite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_FROSITE)));
    public static final Block CUT_FROSITE_WALL = registerBlock("cut_frosite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_FROSITE)));
    ...
    public static final Block FROSITE_PRESSURE_PLATE = registerBlock("frosite_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD,
                    AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK)));
    public static final Block FROSITE_BUTTON = registerBlock("frosite_button",
            new ButtonBlock(BlockSetType.GOLD, 20, AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK)));

    public static final Block ALUMINUM_ORE = registerBlock("aluminum_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_ORE).strength(2.5f, 2.5f)));
    public static final Block DEEPSLATE_ALUMINUM_ORE = registerBlock("deepslate_aluminum_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.DEEPSLATE_IRON_ORE).strength(4.0f, 2.5f)));
    ...
    public static final Block ALUMINUM_PRESSURE_PLATE = registerBlock("aluminum_pressure_plate",
            new WeightedPressurePlateBlock(75, BlockSetType.IRON,
                    AbstractBlock.Settings.copy(Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE)));
    ...
    public static final Block DEEPSLATE_NICKEL_ORE = registerBlock("deepslate_nickel_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.DEEPSLATE_COPPER_ORE)));
    public static final Block NICKEL_BLOCK = registerBlock("nickel_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.STONE_GRAY).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    public static final Block RAW_NICKEL_BLOCK = registerBlock("raw_nickel_block",
            new Block(AbstractBlock.Settings.copy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASEDRUM)
                    .requiresTool()));
    ...
    public static final Block RAW_STEEL_BLOCK = registerBlock("raw_steel_block",
            new Block(AbstractBlock.Settings.copy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.DEEPSLATE_GRAY).instrument(Instrument.BASEDRUM)
                    .requiresTool()));
    ...
    public static final Block SMOOTH_STEEL_SLAB = registerBlock("smooth_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.SMOOTH_STEEL_BLOCK)));
    ...
    public static final Block CUT_STEEL_STAIRS = registerBlock("cut_steel_stairs",
            new StairsBlock(ModBlocks.CUT_STEEL.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.CUT_STEEL)));
    public static final Block CUT_STEEL_SLAB = registerBlock("cut_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_STEEL)));
    ...
    public static final Block STEEL_LAMP = registerBlock("steel_lamp",
            new Block(AbstractBlock.Settings.copy(ModBlocks.STEEL_BLOCK).luminance(state -> 15).solidBlock(Blocks::never)));

    public static final Block STONEBARK_LOG = registerBlock("stonebark_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_STEM).mapColor(MapColor.STONE_GRAY)
    ...
    public static final Block STONEBARK_WOOD = registerBlock("stonebark_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_HYPHAE).mapColor(MapColor.STONE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.STONE)));
    public static final Block STRIPPED_STONEBARK_LOG = registerBlock("stripped_stonebark_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_CRIMSON_STEM).mapColor(MapColor.STONE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.STONE)));
    public static final Block STRIPPED_STONEBARK_WOOD = registerBlock("stripped_stonebark_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_CRIMSON_HYPHAE).mapColor(MapColor.STONE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.STONE)));

    public static final Block STONEBARK_PLANKS = registerBlock("stonebark_planks",
            new Block(AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).mapColor(MapColor.STONE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.STONE)));
    public static final Block STONEBARK_LEAVES = registerBlock("stonebark_leaves",
            new LeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).mapColor(MapColor.LIGHT_BLUE_GRAY)));

    public static final Block DEEPSLATE_LOG = registerBlock("deepslate_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_STEM).mapColor(MapColor.DEEPSLATE_GRAY)
    ...
    public static final Block DEEPSLATE_WOOD = registerBlock("deepslate_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_HYPHAE).mapColor(MapColor.DEEPSLATE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(3.0f, 6.0f)
                    .sounds(BlockSoundGroup.DEEPSLATE)));
    public static final Block STRIPPED_DEEPSLATE_LOG = registerBlock("stripped_deepslate_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_CRIMSON_STEM).mapColor(MapColor.DEEPSLATE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(3.0f, 6.0f)
                    .sounds(BlockSoundGroup.DEEPSLATE)));
    public static final Block STRIPPED_DEEPSLATE_WOOD = registerBlock("stripped_deepslate_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_CRIMSON_HYPHAE).mapColor(MapColor.DEEPSLATE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.DEEPSLATE)));

    public static final Block DEEPSLATE_PLANKS = registerBlock("deepslate_planks",
            new Block(AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).mapColor(MapColor.DEEPSLATE_GRAY)
                    .instrument(Instrument.BASEDRUM).requiresTool().strength(1.5f, 6.0f)
                    .sounds(BlockSoundGroup.DEEPSLATE)));
    public static final Block DEEPSLATE_LEAVES = registerBlock("deepslate_leaves",
            new LeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).mapColor(MapColor.DARK_RED)));

    public static final Block STONEBARK_STAIRS = registerBlock("stonebark_stairs",
            new StairsBlock(ModBlocks.STONEBARK_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_SLAB = registerBlock("stonebark_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_FENCE = registerBlock("stonebark_fence",
            new FenceBlock(AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_FENCE_GATE = registerBlock("stonebark_fence_gate",
            new FenceGateBlock(WoodType.OAK, AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_BUTTON = registerBlock("stonebark_button",
            new ButtonBlock(BlockSetType.STONE, 10,AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_PRESSURE_PLATE = registerBlock("stonebark_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS)));
    public static final Block STONEBARK_DOOR = registerBlock("stonebark_door",
            new DoorBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS).requiresTool()
    ...
    public static final Block STONEBARK_TRAPDOOR = registerBlock("stonebark_trapdoor",
            new TrapdoorBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.STONEBARK_PLANKS).requiresTool()
    ...
    public static final Block STANDING_STONEBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.CRIMSON_SIGN).sounds(BlockSoundGroup.STONE).requiresTool()));
    public static final Block WALL_STONEBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(ModBlocks.STANDING_STONEBARK_SIGN).sounds(BlockSoundGroup.STONE).requiresTool()));
    public static final Block HANGING_STONEBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            STONEBARK_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.CRIMSON_HANGING_SIGN).sounds(BlockSoundGroup.STONE).requiresTool()));
    public static final Block WALL_HANGING_STONEBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            STONEBARK_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(ModBlocks.HANGING_STONEBARK_SIGN).sounds(BlockSoundGroup.STONE).requiresTool()));
    ...
    public static final Block DEEPBARK_STAIRS = registerBlock("deepbark_stairs",
            new StairsBlock(ModBlocks.DEEPSLATE_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_SLAB = registerBlock("deepbark_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_FENCE = registerBlock("deepbark_fence",
            new FenceBlock(AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_FENCE_GATE = registerBlock("deepbark_fence_gate",
            new FenceGateBlock(WoodType.OAK, AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_BUTTON = registerBlock("deepbark_button",
            new ButtonBlock(BlockSetType.STONE, 10,AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_PRESSURE_PLATE = registerBlock("deepbark_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS)));
    public static final Block DEEPBARK_DOOR = registerBlock("deepbark_door",
            new DoorBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS).requiresTool()
                    .nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));
    public static final Block DEEPBARK_TRAPDOOR = registerBlock("deepbark_trapdoor",
            new TrapdoorBlock(BlockSetType.STONE, AbstractBlock.Settings.copy(ModBlocks.DEEPSLATE_PLANKS).requiresTool()
                    .nonOpaque().allowsSpawning(Blocks::never)));
    ...
    public static final Block STANDING_DEEPBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.CRIMSON_SIGN).sounds(BlockSoundGroup.DEEPSLATE).requiresTool()));
    public static final Block WALL_DEEPBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(ModBlocks.STANDING_DEEPBARK_SIGN).sounds(BlockSoundGroup.DEEPSLATE).requiresTool()));
    public static final Block HANGING_DEEPBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            DEEPBARK_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.CRIMSON_HANGING_SIGN).sounds(BlockSoundGroup.DEEPSLATE).requiresTool()));
    public static final Block WALL_HANGING_DEEPBARK_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            DEEPBARK_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(ModBlocks.HANGING_DEEPBARK_SIGN).sounds(BlockSoundGroup.DEEPSLATE).requiresTool()));
    ...
    public static final Block STONEBARK_SAPLING = registerBlock("stonebark_sapling",
            new StonebarkSaplingBlock(ModSaplingGenerators.STONEBARK, AbstractBlock.Settings.copy(Blocks.OAK_SAPLING)));
    public static final Block POTTED_STONEBARK_SAPLING = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.POTTED_OAK_SAPLING).nonOpaque()));


    public static final Block DEEPBARK_SAPLING = registerBlock("deepbark_sapling",
            new DeepbarkSaplingBlock(ModSaplingGenerators.DEEPBARK, AbstractBlock.Settings.copy(Blocks.OAK_SAPLING)));
    ...
    public static final Block TITANIUM_BLOCK = registerBlock("titanium_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.PALE_YELLOW).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    public static final Block RAW_TITANIUM_BLOCK = registerBlock("raw_titanium_block",
            new Block(AbstractBlock.Settings.copy(Blocks.RAW_IRON_BLOCK).mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASEDRUM)
                    .requiresTool()));
    public static final Block NETHER_TUNGSTEN_ORE = registerBlock("nether_tungsten_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(0, 1),
                    AbstractBlock.Settings.copy(Blocks.DEEPSLATE_COPPER_ORE).sounds(BlockSoundGroup.NETHER_ORE)));
    public static final Block TUNGSTEN_BLOCK = registerBlock("tungsten_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.LIGHT_BLUE_GRAY).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    public static final Block TITANIUM_ALLOY_BLOCK = registerBlock("titanium_alloy_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.LIGHT_BLUE).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block COBALT_BLOCK = registerBlock("cobalt_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.BLUE).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block POLISHED_BEDROCK = registerBlock("polished_bedrock",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FAKE_BEDROCK)));
    public static final Block POLISHED_BEDROCK_STAIRS = registerBlock("polished_bedrock_stairs",
            new StairsBlock(ModBlocks.POLISHED_BEDROCK.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK)));
    public static final Block POLISHED_BEDROCK_SLAB = registerBlock("polished_bedrock_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK)));
    public static final Block POLISHED_BEDROCK_WALL = registerBlock("polished_bedrock_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK)));
    ...
    public static final Block POLISHED_BEDROCK_BRICKS_STAIRS = registerBlock("polished_bedrock_bricks_stairs",
            new StairsBlock(ModBlocks.POLISHED_BEDROCK_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK_BRICKS)));
    public static final Block POLISHED_BEDROCK_BRICKS_SLAB = registerBlock("polished_bedrock_bricks_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK_BRICKS)));
    public static final Block POLISHED_BEDROCK_BRICKS_WALL = registerBlock("polished_bedrock_bricks_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_BEDROCK_BRICKS)));
    ...
    public static final Block SANDITE_BRICKS = registerBlock("sandite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.SANDITE_BLOCK)));
    ...
    public static final Block SANDITE_BRICK_STAIRS = registerBlock("sandite_brick_stairs",
            new StairsBlock(ModBlocks.SANDITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.SANDITE_BRICKS)));
    public static final Block SANDITE_BRICK_SLAB = registerBlock("sandite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.SANDITE_BRICKS)));
    public static final Block SANDITE_BRICK_WALL = registerBlock("sandite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.SANDITE_BRICKS)));

    public static final Block CUT_SANDITE_STAIRS = registerBlock("cut_sandite_stairs",
            new StairsBlock(ModBlocks.CUT_SANDITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.CUT_SANDITE)));
    public static final Block CUT_SANDITE_SLAB = registerBlock("cut_sandite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_SANDITE)));
    public static final Block CUT_SANDITE_WALL = registerBlock("cut_sandite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_SANDITE)));
    ...
    public static final Block LEAFITE_BRICKS = registerBlock("leafite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BLOCK)));
    ...
    public static final Block LEAFITE_BRICK_STAIRS = registerBlock("leafite_brick_stairs",
            new StairsBlock(ModBlocks.LEAFITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BRICKS)));
    public static final Block LEAFITE_BRICK_SLAB = registerBlock("leafite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BRICKS)));
    public static final Block LEAFITE_BRICK_WALL = registerBlock("leafite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BRICKS)));

    public static final Block CUT_LEAFITE_STAIRS = registerBlock("cut_leafite_stairs",
            new StairsBlock(ModBlocks.CUT_LEAFITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.CUT_LEAFITE)));
    public static final Block CUT_LEAFITE_SLAB = registerBlock("cut_leafite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_LEAFITE)));
    public static final Block CUT_LEAFITE_WALL = registerBlock("cut_leafite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_LEAFITE)));
    public static final Block LEAFITE_LOG = registerBlock("leafite_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.JUNGLE_LOG).mapColor(MapColor.ORANGE)
                    .instrument(Instrument.BASEDRUM).strength(1.5f, 6.0f)));
    public static final Block LEAFITE_WOOD = registerBlock("leafite_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.JUNGLE_WOOD).mapColor(MapColor.ORANGE)
                    .instrument(Instrument.BASEDRUM).strength(1.5f, 6.0f)));
    public static final Block STRIPPED_LEAFITE_LOG = registerBlock("stripped_leafite_log",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_JUNGLE_LOG).mapColor(MapColor.PALE_GREEN)
                    .instrument(Instrument.BASEDRUM).strength(1.5f, 6.0f)));
    public static final Block STRIPPED_LEAFITE_WOOD = registerBlock("stripped_leafite_wood",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.STRIPPED_JUNGLE_WOOD).mapColor(MapColor.PALE_GREEN)
                    .instrument(Instrument.BASEDRUM).strength(1.5f, 6.0f)));

    public static final Block LEAFITE_PLANKS = registerBlock("leafite_planks",
            new Block(AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).mapColor(MapColor.PALE_GREEN)
                    .instrument(Instrument.BASEDRUM).strength(1.5f, 6.0f)));
    public static final Block LEAFITE_LEAVES = registerBlock("leafite_leaves",
            new LeavesBlock(AbstractBlock.Settings.copy(Blocks.JUNGLE_LEAVES).mapColor(MapColor.GREEN)));
    ...
    public static final Block LEAFITE_PLANKS_STAIRS = registerBlock("leafite_planks_stairs",
            new StairsBlock(ModBlocks.LEAFITE_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_PLANKS_SLAB = registerBlock("leafite_planks_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_PLANKS_FENCE = registerBlock("leafite_planks_fence",
            new FenceBlock(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_PLANKS_FENCE_GATE = registerBlock("leafite_planks_fence_gate",
            new FenceGateBlock(WoodType.JUNGLE, AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_PLANKS_BUTTON = registerBlock("leafite_planks_button",
            new ButtonBlock(BlockSetType.JUNGLE, 10,AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_PLANKS_PRESSURE_PLATE = registerBlock("leafite_planks_pressure_plate",
            new PressurePlateBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)));
    public static final Block LEAFITE_DOOR = registerBlock("leafite_door",
            new DoorBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)
                    .nonOpaque().pistonBehavior(PistonBehavior.DESTROY)));
    public static final Block LEAFITE_TRAPDOOR = registerBlock("leafite_trapdoor",
            new TrapdoorBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.copy(ModBlocks.LEAFITE_PLANKS)
                    .nonOpaque().allowsSpawning(Blocks::never)));
    ...
    public static final Block STANDING_LEAFITE_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.JUNGLE_SIGN)));
    public static final Block WALL_LEAFITE_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.JUNGLE_WALL_SIGN)));
    public static final Block HANGING_LEAFITE_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            LEAFITE_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.JUNGLE_HANGING_SIGN)));
    public static final Block WALL_HANGING_LEAFITE_SIGN = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            LEAFITE_HANDING_GUI_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.JUNGLE_WALL_HANGING_SIGN)));
    ...
    public static final Block LEAFITE_SAPLING = registerBlock("leafite_sapling",
            new SaplingBlock(ModSaplingGenerators.LEAFITE, AbstractBlock.Settings.copy(Blocks.JUNGLE_SAPLING)));
    public static final Block POTTED_LEAFITE_SAPLING = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            ...
            AbstractBlock.Settings.copy(Blocks.POTTED_JUNGLE_SAPLING).nonOpaque()));

    public static final Block WHITE_SAND = registerBlock("white_sand",
            new ColoredFallingBlock(new ColorCode(16777215),AbstractBlock.Settings.copy(Blocks.SAND).mapColor(MapColor.WHITE)));
    public static final Block SUSPICIOUS_WHITE_SAND = registerBlock("suspicious_white_sand",
            new ColoredFallingBlock(new ColorCode(16777215),AbstractBlock.Settings.copy(ModBlocks.WHITE_SAND)));
    public static final Block WHITE_SANDSTONE = registerBlock("white_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE).mapColor(MapColor.WHITE)));
    public static final Block WHITE_SANDSTONE_STAIRS = registerBlock("white_sandstone_stairs",
            new StairsBlock(ModBlocks.WHITE_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.WHITE_SANDSTONE)));
    public static final Block WHITE_SANDSTONE_SLAB = registerBlock("white_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.WHITE_SANDSTONE)));
    public static final Block WHITE_SANDSTONE_WALL = registerBlock("white_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.WHITE_SANDSTONE)));
    public static final Block WHITE_SANDSTONE_TEXTURE = registerBlock("white_sandstone_texture",
            new Block(AbstractBlock.Settings.copy(ModBlocks.WHITE_SANDSTONE)));
    public static final Block CUT_WHITE_SANDSTONE = registerBlock("cut_white_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.CUT_SANDSTONE).mapColor(MapColor.WHITE)));
    public static final Block CUT_WHITE_SANDSTONE_SLAB = registerBlock("cut_white_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_WHITE_SANDSTONE)));
    public static final Block SMOOTH_WHITE_SANDSTONE = registerBlock("smooth_white_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SMOOTH_SANDSTONE).mapColor(MapColor.WHITE)));
    public static final Block SMOOTH_WHITE_SANDSTONE_STAIRS = registerBlock("smooth_white_sandstone_stairs",
            new StairsBlock(ModBlocks.SMOOTH_WHITE_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.SMOOTH_WHITE_SANDSTONE)));
    public static final Block SMOOTH_WHITE_SANDSTONE_SLAB = registerBlock("smooth_white_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.SMOOTH_WHITE_SANDSTONE)));
    public static final Block CHISELED_WHITE_SANDSTONE = registerBlock("chiseled_white_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.CHISELED_SANDSTONE).mapColor(MapColor.WHITE)));

    public static final Block BLACK_SAND = registerBlock("black_sand",
            new ColoredFallingBlock(new ColorCode(0),AbstractBlock.Settings.copy(Blocks.SAND).mapColor(MapColor.BLACK)));
    public static final Block BLACK_SANDSTONE = registerBlock("black_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE).mapColor(MapColor.BLACK)));
    public static final Block BLACK_SANDSTONE_STAIRS = registerBlock("black_sandstone_stairs",
            new StairsBlock(ModBlocks.BLACK_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.BLACK_SANDSTONE)));
    public static final Block BLACK_SANDSTONE_SLAB = registerBlock("black_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.BLACK_SANDSTONE)));
    public static final Block BLACK_SANDSTONE_WALL = registerBlock("black_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.BLACK_SANDSTONE)));
    public static final Block BLACK_SANDSTONE_TEXTURE = registerBlock("black_sandstone_texture",
            new Block(AbstractBlock.Settings.copy(ModBlocks.BLACK_SANDSTONE)));
    public static final Block CUT_BLACK_SANDSTONE = registerBlock("cut_black_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.CUT_SANDSTONE).mapColor(MapColor.BLACK)));
    public static final Block CUT_BLACK_SANDSTONE_SLAB = registerBlock("cut_black_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_BLACK_SANDSTONE)));
    public static final Block SMOOTH_BLACK_SANDSTONE = registerBlock("smooth_black_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SMOOTH_SANDSTONE).mapColor(MapColor.BLACK)));
    public static final Block SMOOTH_BLACK_SANDSTONE_STAIRS = registerBlock("smooth_black_sandstone_stairs",
            new StairsBlock(ModBlocks.SMOOTH_BLACK_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.SMOOTH_BLACK_SANDSTONE)));
    public static final Block SMOOTH_BLACK_SANDSTONE_SLAB = registerBlock("smooth_black_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.SMOOTH_BLACK_SANDSTONE)));
    public static final Block CHISELED_BLACK_SANDSTONE = registerBlock("chiseled_black_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.CHISELED_SANDSTONE).mapColor(MapColor.BLACK)));

    public static final Block TERRACOTTA_GOLD_ORE = registerBlock("terracotta_gold_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.GOLD_ORE).mapColor(MapColor.ORANGE)
    ...
    public static final Block GRAVEL_COAL_ORE = registerBlock("gravel_coal_ore",
            new ColoredFallingBlock(new ColorCode(-8356741),AbstractBlock.Settings.copy(Blocks.COAL_ORE).mapColor(MapColor.STONE_GRAY)
    ...
    public static final Block DRIPSTONE_COPPER_ORE = registerBlock("dripstone_copper_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.COPPER_ORE).mapColor(MapColor.TERRACOTTA_BROWN)
    ...
    public static final Block TUFF_IRON_ORE = registerBlock("tuff_iron_ore",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_ORE).mapColor(MapColor.TERRACOTTA_GRAY)
    ...
    public static final Block SCULK_DIAMOND_ORE = registerBlock("sculk_diamond_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7), AbstractBlock.Settings.copy(Blocks.SCULK).strength(0.2f).requiresTool()));
    public static final Block CLAY_LAPIS_ORE = registerBlock("clay_lapis_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5), AbstractBlock.Settings.copy(Blocks.CLAY).strength(0.6f).requiresTool()));

    public static final Block LAVA_TANK = registerBlock("lava_tank",
            new LavaTankBlock(AbstractBlock.Settings.copy(ModBlocks.TUNGSTEN_BLOCK).luminance(state -> 15).solidBlock(Blocks::never).sounds(BlockSoundGroup.GLASS)));
    public static final Block WATER_TANK = registerBlock("water_tank",
            new Block(AbstractBlock.Settings.copy(ModBlocks.TUNGSTEN_BLOCK).nonOpaque().sounds(BlockSoundGroup.GLASS)));
    public static final Block MILK_TANK = registerBlock("milk_tank",
            new MilkTankBlock(AbstractBlock.Settings.copy(ModBlocks.TUNGSTEN_BLOCK).sounds(BlockSoundGroup.GLASS)));

    public static final Block AWKWARD_WATER_TANK = registerBlock("awkward_water_tank",
            new Block(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));

    public static final Block HEALING_POTION_TANK = registerBlock("healing_potion_tank",
            new HealingPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block FIRE_RESISTANCE_POTION_TANK = registerBlock("fire_resistance_potion_tank",
            new FireResPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block REGENERATION_POTION_TANK = registerBlock("regeneration_potion_tank",
            new RegenerationPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block STRENGTH_POTION_TANK = registerBlock("strength_potion_tank",
            new StrengthPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block SWIFTNESS_POTION_TANK = registerBlock("swiftness_potion_tank",
            new SwiftnessPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block NIGHT_VISION_POTION_TANK = registerBlock("night_vision_potion_tank",
            new NightVisionPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block INVISIBILITY_POTION_TANK = registerBlock("invisibility_potion_tank",
            new InvisibilityPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block WATER_BREATHING_POTION_TANK = registerBlock("water_breathing_potion_tank",
            new WaterBreathingPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block LEAPING_POTION_TANK = registerBlock("leaping_potion_tank",
            new LeapingPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block SLOW_FALLING_POTION_TANK = registerBlock("slow_falling_potion_tank",
            new SlowFallingPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));

    public static final Block POISON_POTION_TANK = registerBlock("poison_potion_tank",
            new PoisonPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block WEAKNESS_POTION_TANK = registerBlock("weakness_potion_tank",
            new WeaknessPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block HARMING_POTION_TANK = registerBlock("harming_potion_tank",
            new HarmingPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block SLOWNESS_POTION_TANK = registerBlock("slowness_potion_tank",
            new SlownessPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));

    public static final Block TURTLE_MASTER_POTION_TANK = registerBlock("turtle_master_potion_tank",
            new TurtleMasterPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));

    public static final Block FROSTBITE_POTION_TANK = registerBlock("frostbite_potion_tank",
            new FrostbitePotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block HEAT_STROKE_POTION_TANK = registerBlock("heat_stroke_potion_tank",
            new HeatStrokePotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block FATAL_POISON_POTION_TANK = registerBlock("fatal_poison_potion_tank",
            new FatalPoisonPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));
    public static final Block VOID_SICKNESS_POTION_TANK = registerBlock("void_sickness_potion_tank",
            new VoidSicknessPotionTankBlock(AbstractBlock.Settings.copy(ModBlocks.WATER_TANK)));

    public static final Block COBBLESTONE_COAL_ORE = registerBlock("cobblestone_coal_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(0, 2), AbstractBlock.Settings.copy(Blocks.COAL_ORE)));
    ...
    public static final Block COBBLESTONE_EMERALD_ORE = registerBlock("cobblestone_emerald_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7), AbstractBlock.Settings.copy(Blocks.EMERALD_ORE)));
    public static final Block COBBLESTONE_ALUMINUM_ORE = registerBlock("cobblestone_aluminum_ore",
            new Block(AbstractBlock.Settings.copy(ModBlocks.ALUMINUM_ORE)));
    public static final Block COBBLESTONE_NICKEL_ORE = registerBlock("cobblestone_nickel_ore",
            new Block(AbstractBlock.Settings.copy(ModBlocks.NICKEL_ORE)));
    ...
    public static final Block MARBLE = registerBlock("marble",
            new Block(AbstractBlock.Settings.copy(Blocks.STONE).mapColor(MapColor.WHITE_GRAY)));
    public static final Block MARBLE_STAIRS = registerBlock("marble_stairs",
            new StairsBlock(ModBlocks.MARBLE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.MARBLE)));
    public static final Block MARBLE_SLAB = registerBlock("marble_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.MARBLE)));
    public static final Block MARBLE_WALL = registerBlock("marble_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.MARBLE)));
    public static final Block MARBLE_BRICKS = registerBlock("marble_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.MARBLE)));
    public static final Block MARBLE_BRICK_STAIRS = registerBlock("marble_brick_stairs",
            new StairsBlock(ModBlocks.MARBLE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.MARBLE_BRICKS)));
    public static final Block MARBLE_BRICK_SLAB = registerBlock("marble_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.MARBLE_BRICKS)));
    public static final Block MARBLE_BRICK_WALL = registerBlock("marble_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.MARBLE_BRICKS)));
    ...
    public static final Block GILDED_MARBLE = registerBlock("gilded_marble",
            new Block(AbstractBlock.Settings.copy(ModBlocks.MARBLE).instrument(Instrument.CHIME)));
    public static final Block GILDED_MARBLE_BRICKS = registerBlock("gilded_marble_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.MARBLE_BRICKS).instrument(Instrument.CHIME)));
    ...
    public static final Block SMOOTH_MARBLE_SLAB = registerBlock("smooth_marble_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.SMOOTH_MARBLE)));
    ...
    public static final Block POLISHED_ANDESITE_BRICK_STAIRS = registerBlock("polished_andesite_brick_stairs",
            new StairsBlock(ModBlocks.POLISHED_ANDESITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.POLISHED_ANDESITE_BRICKS)));
    public static final Block POLISHED_ANDESITE_BRICK_SLAB = registerBlock("polished_andesite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_ANDESITE_BRICKS)));
    public static final Block POLISHED_ANDESITE_BRICK_WALL = registerBlock("polished_andesite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_ANDESITE_BRICKS)));
    ...
    public static final Block POLISHED_DIORITE_BRICK_STAIRS = registerBlock("polished_diorite_brick_stairs",
            new StairsBlock(ModBlocks.POLISHED_DIORITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.POLISHED_DIORITE_BRICKS)));
    public static final Block POLISHED_DIORITE_BRICK_SLAB = registerBlock("polished_diorite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_DIORITE_BRICKS)));
    public static final Block POLISHED_DIORITE_BRICK_WALL = registerBlock("polished_diorite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_DIORITE_BRICKS)));
    ...
    public static final Block POLISHED_GRANITE_BRICK_STAIRS = registerBlock("polished_granite_brick_stairs",
            new StairsBlock(ModBlocks.POLISHED_GRANITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.POLISHED_GRANITE_BRICKS)));
    public static final Block POLISHED_GRANITE_BRICK_SLAB = registerBlock("polished_granite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_GRANITE_BRICKS)));
    public static final Block POLISHED_GRANITE_BRICK_WALL = registerBlock("polished_granite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.POLISHED_GRANITE_BRICKS)));

    public static final Block FLINT_SPIKES = registerBlock("flint_spikes",
            new FlintSpikeBlock(AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).mapColor(MapColor.BLACK).nonOpaque().strength(1.0f, 3.0f)));
    public static final Block IRON_SPIKES = registerBlock("iron_spikes",
            new IronSpikeBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).nonOpaque().strength(1.0f, 3.0f)));
    public static final Block ALUMINUM_SPIKES = registerBlock("aluminum_spikes",
            new IronSpikeBlock(AbstractBlock.Settings.copy(ModBlocks.ALUMINUM_BLOCK).nonOpaque().strength(1.0f, 3.0f)));
    public static final Block STEEL_SPIKES = registerBlock("steel_spikes",
            new SteelSpikeBlock(AbstractBlock.Settings.copy(ModBlocks.STEEL_BLOCK).nonOpaque().strength(1.0f, 3.0f)));

    public static final Block SILVER_CROWN = registerBlock("silver_crown",
            new SilverCrownBlock(AbstractBlock.Settings.create()
    ...
    public static final Block FOSSILIZED_SILVER_SCALES = registerBlock("fossilized_silver_scales",
            new Block(AbstractBlock.Settings.copy(ModBlocks.SILVER_SCALES)
    ...
    public static final Block FOSSILIZED_SILVER_SCALE_FACE = registerBlock("fossilized_silver_scale_face",
            new PillarBlock(AbstractBlock.Settings.copy(ModBlocks.SILVER_SCALE_FACE)
                    .sounds(BlockSoundGroup.BONE)
                    .mapColor(MapColor.STONE_GRAY).requiresTool().strength(1.5f, 6.0f)));

    public static final Block ENDER_DRAGON_TROPHY = Registry.register(Registries.BLOCK, new Identifier(OresMod.MOD_ID,
            "ender_dragon_trophy"),
            new TrophyBlock(AbstractBlock.Settings.create()
    ...
    public static final Block LIGHTY_RUSTED_STEEL_SLAB = registerBlock("lighty_rusted_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHTY_RUSTED_STEEL_BLOCK)));
    ...
    public static final Block LIGHTY_RUSTED_CUT_STEEL_STAIRS = registerBlock("lighty_rusted_cut_steel_stairs",
            new StairsBlock(ModBlocks.LIGHTY_RUSTED_CUT_STEEL.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHTY_RUSTED_CUT_STEEL)));
    public static final Block LIGHTY_RUSTED_CUT_STEEL_SLAB = registerBlock("lighty_rusted_cut_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHTY_RUSTED_CUT_STEEL)));
    ...
    public static final Block RUSTED_STEEL_SLAB = registerBlock("rusted_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.RUSTED_STEEL_BLOCK)));
    ...
    public static final Block RUSTED_CUT_STEEL_STAIRS = registerBlock("rusted_cut_steel_stairs",
            new StairsBlock(ModBlocks.RUSTED_CUT_STEEL.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.RUSTED_CUT_STEEL)));
    public static final Block RUSTED_CUT_STEEL_SLAB = registerBlock("rusted_cut_steel_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.RUSTED_CUT_STEEL)));
    ...
    public static final Block LIGHTY_RUSTED_STEEL_LAMP = registerBlock("lighty_rusted_steel_lamp",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LIGHTY_RUSTED_STEEL_BLOCK).luminance(state -> 7).solidBlock(Blocks::never)));
    public static final Block RUSTED_STEEL_LAMP = registerBlock("rusted_steel_lamp",
            new Block(AbstractBlock.Settings.copy(ModBlocks.RUSTED_STEEL_BLOCK).luminance(state -> 3).solidBlock(Blocks::never)));

    public static final Block VOID_STONE = registerBlock("void_stone",
            new Block(AbstractBlock.Settings.copy(Blocks.END_STONE).mapColor(MapColor.DEEPSLATE_GRAY)));
    ...
    public static final Block PLATINUM_BLOCK = registerBlock("platinum_block",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).mapColor(MapColor.PALE_PURPLE).instrument(Instrument.XYLOPHONE)
                    .requiresTool().sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block END_ITE_ORE = registerBlock("end_ite_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7),
                    AbstractBlock.Settings.copy(Blocks.IRON_ORE).mapColor(MapColor.PALE_YELLOW)));
    ...
    public static final Block END_ITE_BRICKS = registerBlock("end_ite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.END_ITE_BLOCK)));
    ...
    public static final Block END_ITE_BRICK_STAIRS = registerBlock("end_ite_brick_stairs",
            new StairsBlock(ModBlocks.END_ITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.END_ITE_BRICKS)));
    public static final Block END_ITE_BRICK_SLAB = registerBlock("end_ite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.END_ITE_BRICKS)));
    public static final Block END_ITE_BRICK_WALL = registerBlock("end_ite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.END_ITE_BRICKS)));

    public static final Block CUT_END_ITE_STAIRS = registerBlock("cut_end_ite_stairs",
            new StairsBlock(ModBlocks.CUT_END_ITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.CUT_END_ITE)));
    public static final Block CUT_END_ITE_SLAB = registerBlock("cut_end_ite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_END_ITE)));
    public static final Block CUT_END_ITE_WALL = registerBlock("cut_end_ite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.CUT_END_ITE)));

    public static final Block LIGHT_FROSITE_BLOCK = registerBlock("light_frosite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK).mapColor(MapColor.LIGHT_BLUE)));
    public static final Block DARK_FROSITE_BLOCK = registerBlock("dark_frosite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK).mapColor(MapColor.TERRACOTTA_BLUE)));
    public static final Block LIGHT_SANDITE_BLOCK = registerBlock("light_sandite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK).mapColor(MapColor.PALE_YELLOW)));
    public static final Block DARK_SANDITE_BLOCK = registerBlock("dark_sandite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BLOCK).mapColor(MapColor.TERRACOTTA_YELLOW)));
    public static final Block LIGHT_LEAFITE_BLOCK = registerBlock("light_leafite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BLOCK).mapColor(MapColor.TERRACOTTA_ORANGE)));
    public static final Block DARK_LEAFITE_BLOCK = registerBlock("dark_leafite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BLOCK).mapColor(MapColor.SPRUCE_BROWN)));
    public static final Block LIGHT_END_ITE_BLOCK = registerBlock("light_end_ite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.END_ITE_BLOCK).mapColor(MapColor.PALE_PURPLE)));
    public static final Block DARK_END_ITE_BLOCK = registerBlock("dark_end_ite_block",
            new Block(AbstractBlock.Settings.copy(ModBlocks.END_ITE_BLOCK).mapColor(MapColor.TERRACOTTA_PURPLE)));

    public static final Block LIGHT_FROSITE_BRICKS = registerBlock("light_frosite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BRICKS).mapColor(MapColor.LIGHT_BLUE)));
    public static final Block DARK_FROSITE_BRICKS = registerBlock("dark_frosite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.FROSITE_BRICKS).mapColor(MapColor.TERRACOTTA_BLUE)));

    public static final Block LIGHT_CUT_FROSITE = registerBlock("light_cut_frosite",
            new Block(AbstractBlock.Settings.copy(ModBlocks.CUT_FROSITE).mapColor(MapColor.LIGHT_BLUE)));
    public static final Block DARK_CUT_FROSITE = registerBlock("dark_cut_frosite",
            new Block(AbstractBlock.Settings.copy(ModBlocks.CUT_FROSITE).mapColor(MapColor.TERRACOTTA_BLUE)));

    public static final Block LIGHT_FROSITE_BRICK_STAIRS = registerBlock("light_frosite_brick_stairs",
            new StairsBlock(ModBlocks.LIGHT_FROSITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_FROSITE_BRICKS)));
    public static final Block LIGHT_FROSITE_BRICK_SLAB = registerBlock("light_frosite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_FROSITE_BRICKS)));
    public static final Block LIGHT_FROSITE_BRICK_WALL = registerBlock("light_frosite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_FROSITE_BRICKS)));
    public static final Block DARK_FROSITE_BRICK_STAIRS = registerBlock("dark_frosite_brick_stairs",
            new StairsBlock(ModBlocks.DARK_FROSITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_FROSITE_BRICKS)));
    public static final Block DARK_FROSITE_BRICK_SLAB = registerBlock("dark_frosite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_FROSITE_BRICKS)));
    public static final Block DARK_FROSITE_BRICK_WALL = registerBlock("dark_frosite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_FROSITE_BRICKS)));

    public static final Block LIGHT_CUT_FROSITE_STAIRS = registerBlock("light_cut_frosite_stairs",
            new StairsBlock(ModBlocks.LIGHT_CUT_FROSITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_FROSITE)));
    public static final Block LIGHT_CUT_FROSITE_SLAB = registerBlock("light_cut_frosite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_FROSITE)));
    public static final Block LIGHT_CUT_FROSITE_WALL = registerBlock("light_cut_frosite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_FROSITE)));
    public static final Block DARK_CUT_FROSITE_STAIRS = registerBlock("dark_cut_frosite_stairs",
            new StairsBlock(ModBlocks.DARK_CUT_FROSITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_FROSITE)));
    public static final Block DARK_CUT_FROSITE_SLAB = registerBlock("dark_cut_frosite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_FROSITE)));
    public static final Block DARK_CUT_FROSITE_WALL = registerBlock("dark_cut_frosite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_FROSITE)));

    public static final Block LIGHT_FROSITE_PRESSURE_PLATE = registerBlock("light_frosite_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, AbstractBlock.Settings.copy(ModBlocks.LIGHT_FROSITE_BLOCK)));
    public static final Block LIGHT_FROSITE_BUTTON = registerBlock("light_frosite_button",
            new ButtonBlock(BlockSetType.GOLD, 20,AbstractBlock.Settings.copy(ModBlocks.LIGHT_FROSITE_BLOCK)));
    public static final Block DARK_FROSITE_PRESSURE_PLATE = registerBlock("dark_frosite_pressure_plate",
            new PressurePlateBlock(BlockSetType.GOLD, AbstractBlock.Settings.copy(ModBlocks.DARK_FROSITE_BLOCK)));
    public static final Block DARK_FROSITE_BUTTON = registerBlock("dark_frosite_button",
            new ButtonBlock(BlockSetType.GOLD, 20,AbstractBlock.Settings.copy(ModBlocks.DARK_FROSITE_BLOCK)));

    public static final Block LIGHT_SANDITE_BRICKS = registerBlock("light_sandite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LIGHT_SANDITE_BLOCK)));
    public static final Block DARK_SANDITE_BRICKS = registerBlock("dark_sandite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.DARK_SANDITE_BLOCK)));
    ...
    public static final Block LIGHT_SANDITE_BRICK_STAIRS = registerBlock("light_sandite_brick_stairs",
            new StairsBlock(ModBlocks.LIGHT_SANDITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_SANDITE_BRICKS)));
    public static final Block LIGHT_SANDITE_BRICK_SLAB = registerBlock("light_sandite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_SANDITE_BRICKS)));
    public static final Block LIGHT_SANDITE_BRICK_WALL = registerBlock("light_sandite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_SANDITE_BRICKS)));
    public static final Block DARK_SANDITE_BRICK_STAIRS = registerBlock("dark_sandite_brick_stairs",
            new StairsBlock(ModBlocks.DARK_SANDITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_SANDITE_BRICKS)));
    public static final Block DARK_SANDITE_BRICK_SLAB = registerBlock("dark_sandite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_SANDITE_BRICKS)));
    public static final Block DARK_SANDITE_BRICK_WALL = registerBlock("dark_sandite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_SANDITE_BRICKS)));

    public static final Block LIGHT_CUT_SANDITE_STAIRS = registerBlock("light_cut_sandite_stairs",
            new StairsBlock(ModBlocks.LIGHT_CUT_SANDITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_SANDITE)));
    public static final Block LIGHT_CUT_SANDITE_SLAB = registerBlock("light_cut_sandite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_SANDITE)));
    public static final Block LIGHT_CUT_SANDITE_WALL = registerBlock("light_cut_sandite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_SANDITE)));
    public static final Block DARK_CUT_SANDITE_STAIRS = registerBlock("dark_cut_sandite_stairs",
            new StairsBlock(ModBlocks.DARK_CUT_SANDITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_SANDITE)));
    public static final Block DARK_CUT_SANDITE_SLAB = registerBlock("dark_cut_sandite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_SANDITE)));
    public static final Block DARK_CUT_SANDITE_WALL = registerBlock("dark_cut_sandite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_SANDITE)));

    public static final Block LIGHT_LEAFITE_BRICKS = registerBlock("light_leafite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BRICKS).mapColor(MapColor.LIGHT_BLUE)));
    public static final Block DARK_LEAFITE_BRICKS = registerBlock("dark_leafite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LEAFITE_BRICKS).mapColor(MapColor.TERRACOTTA_BLUE)));

    public static final Block LIGHT_CUT_LEAFITE = registerBlock("light_cut_leafite",
            new Block(AbstractBlock.Settings.copy(ModBlocks.CUT_LEAFITE).mapColor(MapColor.LIGHT_BLUE)));
    public static final Block DARK_CUT_LEAFITE = registerBlock("dark_cut_leafite",
            new Block(AbstractBlock.Settings.copy(ModBlocks.CUT_LEAFITE).mapColor(MapColor.TERRACOTTA_BLUE)));

    public static final Block LIGHT_LEAFITE_BRICK_STAIRS = registerBlock("light_leafite_brick_stairs",
            new StairsBlock(ModBlocks.LIGHT_LEAFITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_LEAFITE_BRICKS)));
    public static final Block LIGHT_LEAFITE_BRICK_SLAB = registerBlock("light_leafite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_LEAFITE_BRICKS)));
    public static final Block LIGHT_LEAFITE_BRICK_WALL = registerBlock("light_leafite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_LEAFITE_BRICKS)));
    public static final Block DARK_LEAFITE_BRICK_STAIRS = registerBlock("dark_leafite_brick_stairs",
            new StairsBlock(ModBlocks.DARK_LEAFITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_LEAFITE_BRICKS)));
    public static final Block DARK_LEAFITE_BRICK_SLAB = registerBlock("dark_leafite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_LEAFITE_BRICKS)));
    public static final Block DARK_LEAFITE_BRICK_WALL = registerBlock("dark_leafite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_LEAFITE_BRICKS)));

    public static final Block LIGHT_CUT_LEAFITE_STAIRS = registerBlock("light_cut_leafite_stairs",
            new StairsBlock(ModBlocks.LIGHT_CUT_LEAFITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_LEAFITE)));
    public static final Block LIGHT_CUT_LEAFITE_SLAB = registerBlock("light_cut_leafite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_LEAFITE)));
    public static final Block LIGHT_CUT_LEAFITE_WALL = registerBlock("light_cut_leafite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_LEAFITE)));
    public static final Block DARK_CUT_LEAFITE_STAIRS = registerBlock("dark_cut_leafite_stairs",
            new StairsBlock(ModBlocks.DARK_CUT_LEAFITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_LEAFITE)));
    public static final Block DARK_CUT_LEAFITE_SLAB = registerBlock("dark_cut_leafite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_LEAFITE)));
    public static final Block DARK_CUT_LEAFITE_WALL = registerBlock("dark_cut_leafite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_LEAFITE)));

    public static final Block LIGHT_END_ITE_BRICKS = registerBlock("light_end_ite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.LIGHT_END_ITE_BLOCK)));
    public static final Block DARK_END_ITE_BRICKS = registerBlock("dark_end_ite_bricks",
            new Block(AbstractBlock.Settings.copy(ModBlocks.DARK_END_ITE_BLOCK)));
    ...
    public static final Block LIGHT_END_ITE_BRICK_STAIRS = registerBlock("light_end_ite_brick_stairs",
            new StairsBlock(ModBlocks.LIGHT_END_ITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_END_ITE_BRICKS)));
    public static final Block LIGHT_END_ITE_BRICK_SLAB = registerBlock("light_end_ite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_END_ITE_BRICKS)));
    public static final Block LIGHT_END_ITE_BRICK_WALL = registerBlock("light_end_ite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_END_ITE_BRICKS)));
    public static final Block DARK_END_ITE_BRICK_STAIRS = registerBlock("dark_end_ite_brick_stairs",
            new StairsBlock(ModBlocks.DARK_END_ITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_END_ITE_BRICKS)));
    public static final Block DARK_END_ITE_BRICK_SLAB = registerBlock("dark_end_ite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_END_ITE_BRICKS)));
    public static final Block DARK_END_ITE_BRICK_WALL = registerBlock("dark_end_ite_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_END_ITE_BRICKS)));

    public static final Block LIGHT_CUT_END_ITE_STAIRS = registerBlock("light_cut_end_ite_stairs",
            new StairsBlock(ModBlocks.LIGHT_CUT_END_ITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_END_ITE)));
    public static final Block LIGHT_CUT_END_ITE_SLAB = registerBlock("light_cut_end_ite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_END_ITE)));
    public static final Block LIGHT_CUT_END_ITE_WALL = registerBlock("light_cut_end_ite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.LIGHT_CUT_END_ITE)));
    public static final Block DARK_CUT_END_ITE_STAIRS = registerBlock("dark_cut_end_ite_stairs",
            new StairsBlock(ModBlocks.DARK_CUT_END_ITE.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_END_ITE)));
    public static final Block DARK_CUT_END_ITE_SLAB = registerBlock("dark_cut_end_ite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_END_ITE)));
    public static final Block DARK_CUT_END_ITE_WALL = registerBlock("dark_cut_end_ite_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.DARK_CUT_END_ITE)));
    ...
    public static final Block ICE_BRICK_STAIRS = registerBlock("ice_brick_stairs",
            new StairsBlock(ModBlocks.ICE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(ModBlocks.ICE_BRICKS)));
    public static final Block ICE_BRICK_SLAB = registerBlock("ice_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(ModBlocks.ICE_BRICKS)));
    public static final Block ICE_BRICK_WALL = registerBlock("ice_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(ModBlocks.ICE_BRICKS)));
    public static final Block ICE_PILLAR = registerBlock("ice_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.PACKED_ICE)));

    public static final Block ICY_CROCUS = registerBlock("icy_crocus",
            new FlowerBlock(StatusEffects.SLOWNESS,12, AbstractBlock.Settings.copy(Blocks.ALLIUM).nonOpaque().noCollision()));
    ...
    public static final Block SILVER_ROSE = registerBlock("silver_rose",
            new SilverFlowerBlock(StatusEffects.STRENGTH,9, AbstractBlock.Settings.copy(Blocks.ALLIUM).nonOpaque().noCollision()));
    ...
    public static final Block SUBALPINE_DAISY = registerBlock("subalpine_daisy",
            new FlowerBlock(StatusEffects.REGENERATION,12, AbstractBlock.Settings.copy(Blocks.ALLIUM).nonOpaque().noCollision()));
    ...
    public static final Block ALPINE_SPEEDWELL = registerBlock("alpine_speedwell",
            new FlowerBlock(StatusEffects.SPEED,9, AbstractBlock.Settings.copy(Blocks.ALLIUM).nonOpaque().noCollision()));
